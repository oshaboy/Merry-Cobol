      ...
      * to draw the snowflakes. 
       ...
       01 SNOWFLAKES_RIGHT BACKGROUND-COLOR 0
           HIGHLIGHT FOREGROUND-COLOR 7.
       05 LINE  1 COL 46 PIC X(OFFSET).
       05 LINE  2 COL 46 PIC X(OFFSET).
       05 LINE  3 COL 46 PIC X(OFFSET).
       05 LINE  4 COL 46 PIC X(OFFSET).
       05 LINE  5 COL 46 PIC X(OFFSET).
       05 LINE  6 COL 46 PIC X(OFFSET).
       05 LINE  7 COL 46 PIC X(OFFSET).
       05 LINE  8 COL 46 PIC X(OFFSET).
       05 LINE  9 COL 46 PIC X(OFFSET).
       05 LINE 10 COL 46 PIC X(OFFSET).
       05 LINE 11 COL 46 PIC X(OFFSET).
       05 LINE 12 COL 46 PIC X(OFFSET).
       05 LINE 13 COL 46 PIC X(OFFSET).
       05 LINE 14 COL 46 PIC X(OFFSET).
       05 LINE 15 COL 46 PIC X(OFFSET).
       05 LINE 16 COL 46 PIC X(OFFSET).
       05 LINE 17 COL 46 PIC X(OFFSET).
